...
Download the weights for the trained model from ([Google Drive](https://drive.google.com/drive/folders/18zV-amDe2JP_jiHTXkAdm0k5JZgIXFPK?usp=share_link)) and copy the downloaded weights in the **weights** folder.
