...
if __name__ == "__main__":
    #model paths (weights)
    LAT_VENTRICLE_MODEL_PATH = "weights/lventricle_best_model.pth"
    LAT_CHP_MODEL_PATH = "weights/lchp_best_model.pth"
    THIRD_VENTRICLE_MODEL_PATH = "weights/3ventricle_best_model.pth"
    THIRD_CHP_MODEL_PATH = "weights/3chp_best_model.pth"
